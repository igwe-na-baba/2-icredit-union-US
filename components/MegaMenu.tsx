...
import { 
    ...
    BuildingOfficeIcon, TrophyIcon, HeartIcon, UsersIcon, GlobeAltIcon, CalendarDaysIcon
} from './Icons';
...
const menuConfig: {
    ...
    },
    {
        ...
        items: [
            ...
            { view: 'recurring', label: 'Recurring', description: "Manage subscriptions & bills.", icon: CalendarDaysIcon },
